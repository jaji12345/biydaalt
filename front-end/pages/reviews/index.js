      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="drop-shadow-lm rounded-lg shadow-md p-6 mb-8">
          ...
          <select
            ...
            className="w-full p-3 mt-4 bg-gray-200 text-gray-300 rounded focus:ring-2 focus:ring-gray-400 outline-none"
          >
          ...
          <textarea
            ...
            className="w-full p-3 mt-4 bg-gray-200 text-gray-300 rounded min-h-[120px] focus:ring-2 focus:ring-gray-400 outline-none"
          ></textarea>
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {reviews.map((review) => (
              <div
                ...
                className="bg-gray-200 rounded-lg p-5 drop-shadow-sm relative"
              >
