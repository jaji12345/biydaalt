  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Order Creation Form */}
        <div className=" drop-shadow-lm rounded-lg shadow-md p-6 mb-8">
          <div className="grid md:grid-cols-2 gap-4">
            <input
              ...
              placeholder="User ID"
              className="w-full p-3 bg-gray-200 text-white rounded focus:ring-2 focus:ring-gray-400 outline-none"
            />
            <input
              type="number"
              value={totalAmount}
          ...
          <select
            ...
            className="w-full p-3 mt-4 bg-gray-200 text-gray-400 rounded focus:ring-2 focus:ring-gray-400 outline-none"
          >
        ...
        {isLoading ? (
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {orders.map((order) => (
              <div
                key={order.order_id}
                className="bg-gray-200 rounded-lg p-5 drop-shadow-sm"
              >
            ...
            <div className="bg-gray-800 rounded-lg p-6 w-full max-w-md">
              ...
              <div className="space-y-4">
                <input
                  ...
                  placeholder="User ID"
                  className="w-full p-3 bg-gray-700 text-gray-400 rounded focus:ring-2 focus:ring-blue-500 outline-none"
                />
                <input
                  type="number"
                ...
                <div className="flex space-x-4">
                  <button
                    ...
                    className="flex-1 bg-blue-600 text-gray-400 p-3 rounded hover:bg-blue-700 transition"
                  >
                    Update Order
                  </button>
                  <button
                    ...
                    className="flex-1 bg-gray-600 text-gray-400 p-3 rounded hover:bg-gray-700 transition"
                  >
                    Cancel
                  </button>
                </div>
